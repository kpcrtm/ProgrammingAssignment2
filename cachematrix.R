#
# This file contains two functions to cache the matrix inverse into another environment
#       
#	makeCacheMatrix <- function(x = matrix())
#		creates a special matrix object for caching a matrix in another environment
#	cacheSolve <- function(x, ...)
#		Computes the matrix inverse or returns the version cached in another environment
#		
# I have also included a test function to test the caching of the matrix inverse
#	testCache <- function()
#
...
# makeCacheMatrix:
#
# Create a special matrix object or caching a matrix in another enviroment  The <<- operation is 
